        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="createtable.php">Meal Table</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link" href="deliver.php">Become a Deliver</a>
              </li>

                      </h5><?php if(isset($_SESSION['success'])){  echo "<a class=\"text-dark\" name='logout' href=\"logout.php?logout=1\">Logout</a>";}?>
            </ul>
